...
public class BlockBasicDetectorUnderwaterRail extends DetectorRailBlock implements IWaterLoggable, IUnderwaterRail {

    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

    public BlockBasicDetectorUnderwaterRail(Properties properties) {
        super(properties);
